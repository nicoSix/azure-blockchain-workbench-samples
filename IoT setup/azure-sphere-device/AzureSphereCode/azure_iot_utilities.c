...
//
// Note: this connection string is specific to the device "AzureSphereDevice". To configure other devices,
// see information on iothub-explorer at http://aka.ms/iothubgetstartedVSCS
//
static const char connectionString[] =
    "HostName=nsix-workbench-hub.azure-devices.net;DeviceId=AzureSphereDevice;SharedAccessKey=Mxxpc/pJuTLxoHwESwVYpKgID2EV4ZSRPbCVRjSvitM=";
