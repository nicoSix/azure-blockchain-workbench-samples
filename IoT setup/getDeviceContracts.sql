...
-- Last Modification Date: Mar 7, 2019
-- Description: <Returns device-specific contract info, and create a new field which represents a device ID>
-- =============================================
...
BEGIN
	...
	From 
		...
		from [Application] a
			...
			where UPPER(ar.Name) = 'DEVICE'and u.ExternalDeviceId =  @DeviceID
